...
<body data-bs-spy="scroll" data-bs-target=".navbar" data-bs-offset="51">
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light fixed-top shadow py-lg-0 px-4 px-lg-5 wow fadeIn"
        ...
        <a href="#" class="navbar-brand d-block d-lg-none">
            <h1 class="text-primary fw-bold m-0">Kang Dias</h1>
        </a>
        ...
        <div class="collapse navbar-collapse justify-content-between py-4 py-lg-0" id="navbarCollapse">
            <div class="navbar-nav ms-auto py-0">
                <a href="#misi" class="nav-item nav-link">08 Misi</a>
                <a href="#skill" class="nav-item nav-link">Prestasi & Pendidikan</a>
                <a href="#galeri" class="nav-item nav-link">Galeri</a>
            </div>
            <a href="#" class="navbar-brand bg-primary py-3 px-4 mx-3 d-none d-lg-block">
                <h1 class="text-white fw-bold m-0">Kang Dias</h1>
            </a>
            <div class="navbar-nav me-auto py-0">
                <a href="#team" class="nav-item nav-link">Team</a>
                <a href="#testimonial" class="nav-item nav-link">Testimonial</a>
                <a href="#join" class="nav-item nav-link">Ayo Bergabung</a>
            </div>
        </div>
    </nav>
    <!-- Navbar End -->
        ...
        <div class="container">
            <div class="row g-5 align-items-center">
                <div class="col-lg-6 py-6 pb-0 pt-lg-0">
                    ...
                    <h1 class="display-3 mb-3" id="title-dias">Dias Yudhistira, S.I.P.</h1>
                    <h2 class="typed-text-output d-inline"></h2>
                    <div class="typed-text d-none">#BukanPolitisiGadungan</div>
    ...
    <!-- Amin Start -->
    <div class="container-xxl py-6" id="amin">
    </div>
    <!-- Amin End -->
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="d-flex align-items-center mb-5">
                        <div class="years flex-shrink-0 text-center me-4">
                            <h1 class="display-1 mb-0">0<span style="color: #0DB79A;">8</span></h1>
                            <h5 class="mb-0" style="letter-spacing: 0.8rem">Langkah</h5>
                        </div>
                        <h3 class="lh-base mb-0">Strategis Kang Dias untuk generasi muda Kota Bogor</h3>
                    </div>
                    <p class="mb-4">
                        Dengan tujuan menjadi pendengar dan pemberi solusi yang terbaik bagi generasi muda Kota Bogor,
                        <strong>Kang Dias</strong>
                        berkomitmen untuk menjalankan tugas sebagai anggota parlemen berdasarkan
                        <strong>riset, data dan fakta</strong>.
                    </p>
                    <p class="mb-4">
                        Adapun, terdapat delapan langkah strategis yang harus dilakukan antara lain:
                    </p>
                    <p class="mb-3">
                        <i class="far fa-check-circle text-primary me-3"></i>
                        Berkomitmen menjadi pendengar aspirasi yang baik dan berkelanjutan.
                    </p>
                    <p class="mb-3">
                        <i class="far fa-check-circle text-primary me-3"></i>
                        Membuat kebijakan yang berdasar pada riset, data dan fakta.
                    </p>
                    <p class="mb-3">
                        <i class="far fa-check-circle text-primary me-3"></i>
                    ...
                    <p class="mb-3">
                        <i class="far fa-check-circle text-primary me-3"></i>
                        Membangun layanan <em>youth center</em> sebagai sarana aspirasi dan bereksperimen.
                    </p>
                    <p class="mb-3">
                        <i class="far fa-check-circle text-primary me-3"></i>
                        Menghubungkan antar lembaga terkait pemecahan masalah generasi muda Kota Bogor.
                    </p>
                    <p class="mb-3">
                        <i class="far fa-check-circle text-primary me-3"></i>
                        Membangun jejaring potensi generasi muda Kota Bogor.
                    </p>
                    <p class="mb-3">
                        <i class="far fa-check-circle text-primary me-3"></i>
                        Melakukan pendidikan politik terhadap generasi muda Kota Bogor.
                    </p>
                    <p class="mb-3">
                        <i class="far fa-check-circle text-primary me-3"></i>
                        Terakhir, isi sendiri ygy hehehe.
                    </p>
                    <!-- <a class="btn btn-primary py-3 px-5 mt-3" href="">Selanjutnya</a> -->
                </div>
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="row g-3 mb-4">
                        <div class="col-sm-11">
                            <img class="img-fluid rounded" src="{{ asset('img/kolabirasi.svg') }}" alt="">
                        </div>
                    </div>
    ...
    <div class="container-xxl py-6 pb-5" id="galeri">
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    <h1 class="display-5 mb-5">Prestasi & Pendidikan</h1>
                    ...
                    <div class="tab-content">
                        <div id="tab-1" class="tab-pane fade show p-0 active">
                            <div class="row gy-5 gx-4">
                                <div class="col-sm-6">
                                    <h5>Juara 1 Debat Tingkat Nasional</h5>
                                    <hr class="text-primary my-2">
                                    <p class="text-primary mb-1">2016</p>
                                    <h6 class="mb-0">SMENTION</h6>
                                </div>
                                <div class="col-sm-6">
                                    <h5>Juara 1 Orasi Islam se-Bogor Raya</h5>
                                    <hr class="text-primary my-2">
                                    <p class="text-primary mb-1">2015</p>
                                    <h6 class="mb-0">FLASH 2015</h6>
                                </div>
                                <div class="col-sm-6">
                                    <h5>Juara 3 dan Terfavorit Duta Generasi Berencana Kota Bogor</h5>
                                    <hr class="text-primary my-2">
                                    <p class="text-primary mb-1">2020</p>
                                    <h6 class="mb-0">Genre Kota Bogor</h6>
                                </div>
                                <div class="col-sm-6">
                                    <h5>Top 5 Pusat Informasi dan Konseling Remaja Tingkat Nasional</h5>
                                    <hr class="text-primary my-2">
                                    <p class="text-primary mb-1">2023</p>
                                    <h6 class="mb-0">Genre Indonesia</h6>
                                </div>
                            </div>
                        </div>
                        <div id="tab-2" class="tab-pane fade show p-0">
                            <div class="row gy-5 gx-4">
                                <div class="col-sm-6">
                                    <h5>SMA Negeri 5 Kota Bogor</h5>
                                    <hr class="text-primary my-2">
                                    <p class="text-primary mb-1">Lulus pada tahun 2017</p>
                                    <h6 class="mb-0">Ilmu Pengetahuan Sosial</h6>
                                </div>
                                <div class="col-sm-6">
                                    <h5>Universitas Indonesia</h5>
                                    <hr class="text-primary my-2">
                                    <p class="text-primary mb-1">Lulus pada tahun 2023</p>
                                    <h6 class="mb-0">Sarjana Ilmu Politik</h6>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-3 d-none d-lg-block">
                    <div class="testimonial-left h-100">
                        ...
                        <img class="img-fluid wow fadeIn" data-wow-delay="0.5s"
                            src="{{ asset('img/testimonial-3.jpg') }}" alt="">
                    </div>
                </div>
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
    ...
    <!-- Contact Start -->
    <div class="container-xxl pb-5" id="join">
        <div class="container py-5">
            <div class="row g-5 mb-5 wow fadeInUp" data-wow-delay="0.1s">
                <div class="col-lg-6">
                    <h1 class="display-5 mb-0">Ayo Bergabung!</h1>
                </div>
                <!-- <div class="col-lg-6 text-lg-end">
            ...
            <div class="row g-5">
                <div class="col-lg-5 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <div class="d-flex pt-2">
                        <span>
                            <a class="btn btn-square btn-primary me-2" href="https://www.instagram.com/diasyuds/"
                                target="_blank" style="width: 5em; height: 5em;">
                ...
                <div class="col-lg-7 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <p class="mb-4">Untuk menciptakan perubahan politik yang lebih baik di Kota Bogor dan lebih dekat
                        dengan generasi muda, ayo kita bergerak bersama!</p>
                    <form method="POST" action="{{ route('join-volunteer') }}" id="join-form">
                        @csrf
                        <div class="row g-3">
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text"
                                        ...
                                        id="full_name" name="full_name" required placeholder="Nama"
                                        value="{{ old('full_name') }}">
                                    @if ($errors->has('full_name'))
                                        <small
                                            class="text-small text-danger">{{ $errors->first('full_name') }}</small>
                                    @endif
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text"
                                        class="form-control {{ $errors->has('ig_account') ? 'is-invalid' : '' }}"
                                        id="ig_account" name="ig_account" required placeholder="Nama"
                                        value="{{ old('ig_account') }}">
                                    @if ($errors->has('ig_account'))
                                        <small
                                            class="text-small text-danger">{{ $errors->first('ig_account') }}</small>
                                    @endif
                                    <label for="ig_account">Akun Instagram</label>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="email"
                                        ...
                                        value="{{ old('email') }}">
                                    @if ($errors->has('email'))
                                        <small class="text-small text-danger">{{ $errors->first('email') }}</small>
                                    @endif
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    ...
                                    @if ($errors->has('phone'))
                                        <small class="text-small text-danger">{{ $errors->first('phone') }}</small>
                                    @endif
                            ...
                            <div class="col-12">
                                <div class="form-floating">
                                    <textarea class="form-control {{ $errors->has('motivation') ? 'is-invalid' : '' }}" required
                                        placeholder="Motivasi Bergabung" id="motivation" name="motivation" style="height: 100px">{{ old('motivation') }}</textarea>
                                    @if ($errors->has('motivation'))
                                        <small
                                            class="text-small text-danger">{{ $errors->first('motivation') }}</small>
                                    @endif
                                    <label for="motivation">Motivasi</label>
                                </div>
                            </div>
                            <div class="col-12">
                                <button class="btn btn-primary py-3 px-5" type="submit">Bergabung</button>
                            </div>
                        </div>
                    </form>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                    &copy; <a class="border-bottom text-secondary" href="#">kangdias.site</a>, All Right
                    Reserved.
                </div>
    ...
    <script>
        document.getElementById('join-form').addEventListener('submit', function(e) {
            ...
            if (phoneNumber.value.length <= 8) {
                return Swal.fire({
                    ...
                    text: 'Nomor Whatsapp minimal 8 karakter',
                    icon: 'info'
                });
            }
        ...
        document.getElementById('phone').addEventListener('input', function() {
            ...
            if (value.startsWith('08')) {
                if (value.length <= 13) {
                    this.value = value; // Set the updated value
                } else {
                    this.value = value.slice(0, 13); // Trim to 13 characters if longer
                }
            } else {
                // If it doesn't start with '08', only consider the substring starting with '08'
                this.value = '08' + value.substring(2, 13);
            }
        });
    </script>
    ...
    @if (Session::has('error') || $errors->any())
        <script>
            Swal.fire({
                ...
                text: 'Maaf data yang anda masukan kurang valid',
                icon: 'error'
            });
        </script>
    @endif
